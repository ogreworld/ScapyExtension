...
class StrStartStopFieldStripped(StrStopField):
    def i2h(self, pkt, x):
        start_strip = x.strip(' ')
        return start_strip.rstrip()
...
class FTPResArgField(StrStartStopFieldStripped):
    """
    ...
    def __init__(self, name, default, fmt, remain=0):
        ...
        """
        self.name = name
        StrStartStopFieldStripped.__init__(self, name, default, fmt, remain)
        
    


class FTPResField(StrEnumField):
    """
    ...
    def __init__(self, name, default, fmt, enum, remain=0):
        """
        ...
        """
        self.name = name
        StrEnumField.__init__(self, name, default, fmt, enum, remain)
...
class FTPResponse(Packet):
    ...
    """
    name = "FTPResponse"
    fields_desc = [FTPResField("cmd", "", "H", CODES),
                   StrStartStopFieldStripped("argument", "", "H")]
