...
icmp6typescls = {    1: "ICMPv6DestUnreach",
                  ...
                  #138: Do Me - RFC 2894 - Seems painful
                   ...
                   141: "ICMPv6ND_INDSol",
                   142: "ICMPv6ND_INDAdv",
                   143: "ICMPv6MLReport2",    #Do Me - RFC 3810
...
MLDv2grtypes = { 1 : "IS_IN",   #"Mode Is Include",
...
class MLD2gr(Packet):
    ...
    name = "MLDv2 address Record"
    fields_desc = [ ByteEnumField("rtype", 1, MLDv2grtypes),
                   ByteField("auxdlen",0),
                   ShortField("numsrc", 0),
                   IP6Field("maddr",None),
                   FieldListField("srcaddrs", None, IP6Field("sa", None), count_from = lambda x:x.numsrc), ]
    show_indent=0
        
    def mysummary(self):
        '''Display a summary of the MLDv2 group record.'''
        return self.sprintf("MLDv2 Group Record %MLDv2gr.type% %IGMPv3gr.maddr%")

    def extract_padding(self, p):
        return "",p
        
class _MLDv2AddressRecordField(PacketListField):
...
class ICMPv6MLReport2(_ICMPv6ML): # RFC 3810 RFC5790
    name = "MLDv2 - Version 2 Multicast Listener Report"
    type = 143
    overload_fields = {IPv6: {"hlim": 1}}
    fields_desc = [ ByteEnumField("type", 143, icmp6types),
                    ...
                    ShortField("reserved", 0),
                    ShortField("numard", 0),
                    _MLDv2AddressRecordField("addessrecords", None, MLD2gr, count_from= lambda x:x.numard)]
    # implementer le hashret et le answers
