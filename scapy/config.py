...
"""
    ...
    temp_files = []
    netcache = NetCache()
    load_layers = ["l2", "igmp" , "inet", "dhcp", "dns", "dot11", "gprs", "hsrp", "inet6", "ir", "isakmp", "l2tp", "pptp" , 
                   "mgcp", "mobileip", "netbios", "netflow", "ftp", "sip",
                   "http", "irc", "smtp", "imap", "pop", "ssh", "ntp", "ppp", "radius", "rip", "rtp",
